...
// Para ImageNet (160x160 RGB) usamos RGB565 y convertimos a RGB888 int8.
static camera_config_t kCameraConfig = {
    ...
    .frame_size = FRAMESIZE_240X240,  // capturamos más grande y recortamos a 160x160
    .jpeg_quality = 12,
    .fb_count = 1,
...
// Recorta el centro 160x160 del frame 240x240 RGB565 y lo convierte a int8 RGB888
// con zero_point = -128 (cuantización simétrica estándar de TFLite int8).
